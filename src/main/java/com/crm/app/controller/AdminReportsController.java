...
public class AdminReportsController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("totalUsers", userDao.countUsersByCompany(companyName));
        ...
        request.setAttribute("customersPerUser", customerDao.getCustomerCountPerUser(companyName));
        request.setAttribute("activityTrend", buildActivityTrend(companyName));

        request.getRequestDispatcher("/view/dashboard/admin-reports.jsp").forward(request, response);
    }
